...
class BCICIV2b(BaseDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        X = np.concatenate(
            [run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for train_dataset in train_datasets for run
        ...
        X_test = np.concatenate(
            [run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for test_dataset in test_datasets for run in
...
class BCICIV2bLOSO(BCICIV2b):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        X_test = np.concatenate([run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for test_dataset in test_datasets

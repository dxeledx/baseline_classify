...
class BCICIV2a(BaseDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        # load the data (compatible with braindecode 0.8.x)
        X = np.concatenate(
            [run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for run in train_dataset.datasets], axis=0)
        y = np.concatenate([run.y for run in train_dataset.datasets], axis=0)
        X_test = np.concatenate(
            [run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for run in test_dataset.datasets], axis=0)
...
class BCICIV2aTVT(BaseDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        # Load session 1 data (compatible with braindecode 0.8.x)
        X = np.concatenate([run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for run in session1.datasets], axis=0)
        ...
        # Load session 2 as test set (compatible with braindecode 0.8.x)
        X_test = np.concatenate([run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for run in session2.datasets], axis=0)
...
class BCICIV2aLOSO(BCICIV2a):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        # load the data (compatible with braindecode 0.8.x)
        X = np.concatenate([run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for train_dataset in
        ...
        X_val = np.concatenate([run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for val_dataset in
        ...
        X_test = np.concatenate([run.load_data()._data if hasattr(run, 'load_data') else run.windows.load_data()._data for run in test_dataset.datasets],
                                axis=0)
        y_test = np.concatenate([run.y for run in test_dataset.datasets], axis=0)
